...
IN_VCF="/scratch.global/pmorrell/WBDC_resequencing/VCFs/all_chromosomes.gatk_mapq20_filtered_snp_pass_rename_renamed-chrs.vcf.gz"
OUT_VCF="/scratch.global/pmorrell/WBDC_resequencing/VCFs/all_chromosomes.gatk_mapq20_filtered_snp_pass_rename_renamed-chrs_biallelic.vcf.gz"
